...
const teacherProfiles = [
  ...
  },
  {
    ...
    bio: "Focuses on beginner Arabic grammar, vocabulary growth, and speaking confidence.",
  ...
  },
  {
    ...
    bio: "Supports Seerah delivery through class discussion, follow-up prompts, and reflection.",
