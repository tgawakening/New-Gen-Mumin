      ...
      <section id="weekly-certificate" className="scroll-mt-6 grid gap-5 xl:grid-cols-[1fr_1.08fr]">
        <div className="relative overflow-hidden rounded-[30px] border border-[#eadfce] bg-white p-6 shadow-sm">
          <div className="relative z-10 max-w-[62%]">
            ...
            <div className="mt-3 inline-flex items-center gap-2 rounded-full bg-[#e9f7ee] px-3 py-2 text-xs font-bold text-[#27734b]"><HandHeart className="h-4 w-4" />{featured?.category ?? "Character growth"}</div>
        ...
        <div className="rounded-[30px] border border-[#dca142] bg-[#11294a] p-3 shadow-[0_18px_45px_rgba(17,41,74,0.2)]">
          <div className="relative min-h-[310px] overflow-hidden rounded-[22px] border-2 border-[#e5b85f] bg-[#fffaf1] p-5">
            <div className="pointer-events-none absolute inset-3 rounded-[16px] border border-[#e5b85f]/60" />
            <div className="relative flex items-center justify-between"><span className="flex h-12 w-12 items-center justify-center rounded-full bg-[#17375d] text-[#ffd274] shadow-md"><HandHeart className="h-6 w-6"/></span><div className="text-center"><p className="text-[10px] font-black uppercase tracking-[.28em] text-[#c27a2c]">Generation Mumin</p><p className="mt-1 font-serif text-xs font-bold uppercase tracking-[.14em] text-[#657184]">Certificate of Character</p></div><span className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-[#ffcf66] to-[#d87515] text-white shadow-md"><Award className="h-7 w-7"/></span></div>
            <div className="relative mt-3 grid min-h-[190px] grid-cols-[112px_minmax(0,1fr)] items-center gap-5 px-1 sm:grid-cols-[138px_minmax(0,1fr)]">
              <div className="relative h-[170px] overflow-hidden rounded-[24px] border-2 border-[#edc36f] bg-[#fff3d4]"><Character data={data} className="absolute inset-0 h-full w-full"/></div>
              <div className="text-center"><p className="text-xs font-semibold text-[#6d7785]">Proudly presented to</p><h3 className="mt-1 text-2xl font-black sm:text-3xl text-[#14233e]">{name}</h3><p className="mt-1.5 font-serif text-lg sm:text-xl font-bold uppercase tracking-[.1em] text-[#bd6e1d]">{spotlightTitle}</p><div className="mx-auto mt-2.5 inline-flex items-center gap-2 rounded-full bg-[#e9f7ee] px-3 py-1.5 text-[10px] font-black uppercase tracking-[.1em] text-[#27734b]"><Shield className="h-3.5 w-3.5"/>{featured?.category ?? "Character growth"}</div><p className="mx-auto mt-2.5 line-clamp-3 max-w-md text-xs leading-5 text-[#596779]">{spotlightEvidence}</p>{featured ? <Link href={`/certificates/${featured.certificateCode}`} className="mt-3 inline-flex items-center gap-2 rounded-full bg-[#11294a] px-5 py-2.5 text-xs font-bold text-white shadow-lg transition hover:-translate-y-0.5"><Download className="h-4 w-4"/>Open, print or download</Link> : <span className="mt-4 inline-flex rounded-full border border-[#d7c5aa] px-4 py-2 text-xs font-bold text-[#7c6a50]">Earn a badge to unlock</span>}</div>
            </div>
            <div className="relative mt-2 border-t border-[#dfc18b] pt-2 text-center text-[9px] font-bold uppercase tracking-[.14em] text-[#8a6a35]">Points celebrate progress. Character is the goal.</div>
          </div>
        </div>      </section>
