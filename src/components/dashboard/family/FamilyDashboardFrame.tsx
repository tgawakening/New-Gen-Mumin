    ...
    <div className="min-h-screen bg-[#f7f2ea]">
      ...
      <div className="section-container grid grid-cols-[64px_minmax(0,1fr)] gap-3 py-5 sm:gap-5 sm:py-6 xl:grid-cols-[220px_minmax(0,1fr)] xl:gap-5 xl:py-8">
        <aside className="sticky top-3 self-start">
          <div className="relative max-h-[calc(100vh-1.5rem)] overflow-visible rounded-[22px] bg-[#22304a] p-2 text-white shadow-[0_20px_50px_rgba(34,48,74,0.18)] xl:overflow-y-auto xl:rounded-[24px] xl:p-4">
