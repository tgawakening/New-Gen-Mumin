...
const pointWays = [
  { icon: Clock3, label: "Attend a live class", points: 5, note: "Join at any time; once per eligible class, including parent-confirmed attendance", tone: "bg-[#e7f1ff] text-[#2465a5]" },
