  ...
  return (
    <div className="min-h-screen bg-[#f6f1e8]">
      ...
      <div className="section-container grid gap-5 py-8 xl:grid-cols-[220px_minmax(0,1fr)]">
        <aside className="sticky top-3 self-start space-y-5">
          <div className="max-h-[calc(100vh-1.5rem)] overflow-y-auto rounded-[24px] bg-[#22304a] p-4 text-white shadow-[0_20px_50px_rgba(34,48,74,0.22)]">
