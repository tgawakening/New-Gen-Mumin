          ...
          <div className="flex-1 overflow-y-auto px-6 py-5">
            ...
            <nav className="space-y-3 text-[15px] font-semibold text-[#374151]">
              ...
              <div className="border-b border-gray-100 pb-2">
                ...
                >
                  <span className="text-[15px] font-semibold">{PROGRAMS_LABEL}</span>
                  <span className="flex h-7 w-7 items-center justify-center rounded-full border border-[#F59E0B] bg-[#FEF3C7] text-[#F97316]">
