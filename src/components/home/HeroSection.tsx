...
export function HeroSection() {
  return (
    <section className="relative min-h-[calc(100svh-180px)] lg:min-h-[calc(100vh-184px)] flex flex-col overflow-hidden bg-[#FDF6EF] pt-4 md:pt-6 lg:pt-8 pb-12 md:pb-14">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex-1 flex flex-col justify-center lg:justify-end">
        <div className="grid md:grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] items-end gap-10 lg:gap-8">
          ...
          <div className="text-center lg:text-left relative self-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.4rem] xl:text-[3.75rem] font-heading font-semibold leading-tight lg:leading-[1.08] mb-6 lg:mb-7 text-[#4A5568]">
              Raising Confident & <br/>Thoughtful <span className="text-kidsa-orange-500">Muslim</span> Leaders.
            </h1>

            <p className="text-base sm:text-lg lg:text-xl text-[#5C707E] max-w-xl lg:max-w-2xl mb-8 leading-relaxed lg:leading-relaxed mx-auto lg:mx-0 font-sans">
