...
export function TopBar() {
  return (
    <div className="relative w-full overflow-hidden topbar-bg">
      <div className="text-[#385469] text-[15px] font-semibold font-sans flex items-center min-h-[60px] py-2.5">
        <div className="section-container w-full">
          <div className="flex flex-wrap items-center justify-between gap-x-8 gap-y-2">
            <div className="flex items-center gap-6">
              <a
                href={`mailto:${SITE.email}`}
                className="flex items-center gap-2 hover:text-[#6B5B95] transition-colors"
              >
                <span className="flex items-center justify-center w-6 h-6 rounded-full border border-[#385469]/50">
              ...
              <div className="flex items-center gap-3">
                {SOCIAL_LINKS.map((link) => (
                  <a
                    ...
                    className="hover:text-[#6B5B95] transition-colors"
