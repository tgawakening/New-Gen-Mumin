...
export default async function CertificatePage({ params }: Props) {
  ...
  const character = gender.includes("girl") || gender.includes("female") ? "/gen-mumin-chars/rania-superhero.png" : "/gen-mumin-chars/ali-superhero.png";
  ...
  return <main className="min-h-screen bg-[#eef2f7] p-3 sm:p-6 print:bg-white print:p-0">
    ...
    <div className="relative mx-auto aspect-[1.414/1] w-full max-w-[1120px] overflow-hidden border-[10px] border-[#10294a] bg-[#fffaf0] shadow-2xl print:h-[190mm] print:w-[277mm] print:max-w-none print:shadow-none">
