...
import { createLiveClass, syncScheduleToZoom } from "@/lib/live-classes/service";
      ...
      <div className="section-container space-y-5">
        ...
        <section className="rounded-[28px] border border-[#dce4ed] bg-white p-6 shadow-sm">
          ...
          <form action={createClassAction} className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <label className="space-y-2 text-sm font-semibold text-[#22304a]">
              Teacher
              <select name="teacherId" required className="w-full rounded-2xl border border-[#dce4ed] bg-white px-4 py-3 text-sm">
            ...
            <label className="space-y-2 text-sm font-semibold text-[#22304a]">
              Timezone
              <input name="timezone" defaultValue="Europe/London" required className="w-full rounded-2xl border border-[#dce4ed] bg-white px-4 py-3 text-sm" />
            </label>
