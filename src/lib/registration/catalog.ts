...
export const DEFAULT_PROGRAMS: CatalogProgram[] = [
  ...
  },
  {
    ...
    shortDescription: "Arabic language foundations with Qur'anic tajweed, makharij, and guided recitation practice.",
    monthlyPriceGbp: 50,
...
export const DEFAULT_OFFERS: CatalogOffer[] = [
  ...
  },
  {
    ...
    title: "Arabic & Tajweed",
    kind: "SINGLE",
    description: "Combined monthly enrollment for Arabic and Qur'anic Tajweed.",
  ...
  },
  {
    ...
    title: "Arabic & Tajweed",
    kind: "PAIR",
    description: "Combined language and recitation track.",
    programSlugs: ["arabic", "tajweed"],
    basePriceGbp: 50,
    basePricePkr: 7000,
  },
