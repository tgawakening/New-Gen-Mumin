...
export const genMTerms: GenMTermPlan[] = [
  {
    ...
    arabic: ["Al-Arabiyyah Bayna Yaday Awladina 1-2", "Alphabet mastery", "8 dialogues", "10 speaking games"],
  ...
  },
  {
    ...
    arabic: ["Al-Arabiyyah Bayna Yaday Awladina 3-4", "Masculine/feminine", "16 dialogues", "16 reading paragraphs"],
  ...
  },
  {
    ...
    arabic: ["Al-Arabiyyah Bayna Yaday Awladina 5", "Paragraph writing", "Food, health, and clothing vocabulary"],
  ...
  },
  {
    ...
    arabic: ["Al-Arabiyyah Bayna Yaday Awladina 6", "Stories and paragraphs", "250 phrases", "Presentations in Arabic"],
