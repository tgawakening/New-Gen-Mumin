...
export const genMTeachers: GenMTeacherProfile[] = [
  {
    ...
    title: "Program Lead Coordinator",
  ...
  },
  {
    ...
    credential: "CEO â€“ Al Ummah Leaders Institute",
    bio: "Provides overall mentoring direction and supports tajweed continuity inside the wider Gen-Mumins learning pathway.",
    email: "abubakar98114@gmail.com",
    specialties: ["Mentoring", "Qur'an support", "Programme continuity"],
  ...
  },
  {
    ...
    title: "Seerah Instructor",
    credential: "Gen-Mumins Seerah Faculty",
  ...
  },
  {
    ...
    credential: "MBBS",
    bio: "Supports the wider life-skills stream with health awareness, safety habits, and practical family follow-up guidance.",
    email: "javeriariaz145@gmail.com",
    specialties: ["Health awareness", "Safety habits", "Family guidance"],
    programSlugs: ["life-lessons"],
  },
];
